...
- **Mothers & Caregivers**: To test the usability, tone, and emotional resonance of the design.
- **Investors & Partners**: To view the product vision, premium aesthetic, and technical foundation.

## ⏱️ 5-Minute Demo Path
To experience the core value of Mama Guard in one sitting:
1. **Onboarding**: Set up a profile at the [Start Page](https://guard-pink.vercel.app/).
...
- **Assistant**: https://guard-pink.vercel.app/ai
- **Check-in**: https://guard-pink.vercel.app/checkin
...
- **Backend Status**: This is a frontend-only demo. All data is stored in your browser's local storage and is lost if the cache is cleared.
- **Non-Diagnostic**: The app provides "Review" or "Needs Care" status based on symptom thresholds, but never provides a medical diagnosis.
- **Demo Content**: Some educational articles in the "Learn" tab are placeholders for the final medical-reviewed content.

## ⚠️ Safety Boundaries
> [!IMPORTANT]
> - **NOT FOR EMERGENCIES**: If you are in pain or feel unsafe, call your doctor or 911 immediately.
> - **PRIVACY**: Do not use real names or private medical data.
> - **NO REAL-TIME MONITORING**: No one is monitoring your inputs on the other end. This is an autonomous support tool.
